...
import { buildPickTrigger, fetchRankingSession, startPick, renderRankingSession } from './groupWatchRanking.js';
...
export async function openGroupWatch() {
  ...
  // reading as broken rather than live. Still a real full rebuild
  // underneath either way, list.textContent = '' and all, a plainer real
  // fix than diffing row by row for how often this actually runs.
